...
export const EDIT_USER_EXPERIENCES_FAILURE = "EDIT_USER_EXPERIENCES_FAILURE";
...
export const UPDATE_LATEST_SEARCH = "UPDATE_LATEST_SEARCH";
...
export const FETCH_USER_BY_USER_NAME_REQUEST =
  "FETCH_USER_BY_USER_NAME_REQUEST";
export const FETCH_USER_BY_USER_NAME_SUCCESS =
  "FETCH_USER_BY_USER_NAME_SUCCESS";
export const FETCH_USER_BY_USER_NAME_FAILURE =
  "FETCH_USER_BY_USER_NAME_FAILURE";
